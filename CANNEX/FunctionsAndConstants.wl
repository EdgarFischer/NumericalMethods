...
AppendTo[Output,DVeff[\[Phi]Old[[-1]],a,b,c,rho[[-1]]]  -DDVeff[\[Phi]Old[[-1]],a,b,c,rho[[-1]]]*\[Phi]Old[[-1]] -Block[{$MaxExtraPrecision=1000},\[Phi]\[Rho][a,b,c,\[Rho]M]]/(H[[-1]]^2*m2invMeV^2)](*from 2nd bountady condition*);
Output]
...
Pressure[a_,b_,c_,DVeff_,DDVeff_]:=\[Rho]M/(\[Rho]M-\[Rho]V)*(Veff[\[Phi]\[Rho][a,b, c,\[Rho]V],a,b, c,\[Rho]V]-Veff[SOLVEFD[a,b,c,points,Prec,MAX,"Default",DVeff,DDVeff][[2]][0],a,b, c,\[Rho]V])*m2invMeV^2/N2invMeV2
